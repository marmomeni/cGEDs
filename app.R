...
ui <- dashboardPage(
  ...
  sidebar <- dashboardSidebar(
    sidebarMenu(
      ...
      menuItem("Bubble Plot", tabName = "bubblePlot",icon =tags$i(class = "fas fa-braille")),
      menuItem("Scatter-Boxplot", tabName = "scatterBoxplot",icon =tags$i(class="fas fa-dice-five")),
